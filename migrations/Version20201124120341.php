 ...
 */
final class Version20201124120341 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE payment ADD CONSTRAINT FK_6D28840DB8401E04 FOREIGN KEY (blue_card_id) REFERENCES blue_card (id)');
